...
const StealthToggle = () => {
    ...
    return (
        <button
            ...
            className={`fixed bottom-8 right-8 z-[6000] p-4 rounded-2xl border transition-all duration-500 backdrop-blur-xl flex items-center gap-3 group ${isStealth ? 'border-primary bg-primary/20 text-primary shadow-[0_0_20px_#00f0ff33]' : 'border-white/5 bg-white/5 text-gray-500'
                }`}
        ...
        >
            ...
            <span className="font-mono text-[9px] tracking-[0.3em] uppercase opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
